$(document).ready(function () {
     ...
     */
    var content = [{
        title: "Aku ingin kamu membaca ini",
        desc: ""
    }, {
        title: "",
        desc: "Mungkin ini kalimat yang cukup sederhana, kalimat yang menyimpan banyak harapan dan keraguan di baliknya. Ada harapan yang menginginkan agar perasaan cinta itu tidak jatuh begitu saja, ada pula yang harus dipersiapkan agar bisa menerima konsekuensinya."
    }, {
       title: "",
       desc: "mengungkapkan perasaan adalah hal yang cukup serius, banyak yang akan dikorbankan termasuk hasil akhir melepaskan sesuatu yang sudah lama tersimpan merupakan hal yang cukup melegakan dan bukan hal yang mudah. ​​Di sini aku hanya ingin mengungkapkan perasaanku kepadamu, masalah diterima atau tidak itu tergantung padamu, aku juga tidak akan berharap lebih kok."
    }, {
        title: "",
        desc: "Kalau kamu nggak enak bilang aja, aku suka sama kamu, kalau kamu udah punya pacar, maaf ya.. mungkin segitu aja dari aku, hehe makasih udah baca ini"
    }, {
